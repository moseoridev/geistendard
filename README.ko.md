...
Geistendard는 터미널과 IDE 사용을 위한 하이브리드 폰트를 빌드합니다. 라틴
...
사용하고, Geistendard 맞춤/메타데이터와 선택적 Nerd Fonts 패치를 제공합니다.

한글/CJK 글리프는 라틴 고정폭의 정확히 두 배 폭에 맞춰집니다. 기본 한글 배율은
`1.10`이며, 터미널에서 덜 과한 중간값입니다.
...
Geistendard는 터미널과 IDE 사용을 목표로 합니다. 기본 출력은 Geist Mono 라틴
렌더링, 한글/CJK 맞춤, Nerd Font 심볼을 우선합니다.

## 시각 확인 샘플

Geistendard를 다른 고정폭 기준 폰트와 비교할 때는 동일한 렌더러, 포인트 크기,
줄 높이를 사용하세요.
...
Geistendard는 [SIL Open Font License 1.1](LICENSE)에 따라 배포됩니다. 전체
저작권 및 reserved name 고지는 업스트림 Geist Mono, Nerd Fonts, Pretendard,
Jetendard 프로젝트를 확인하세요.
